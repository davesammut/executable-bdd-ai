...
if __name__ == "__main__":
    ...
    from api.adapters.cart_value_data_provider_adapter import CartValueAdapter
    from api.adapters.product_data_provider_adapter import ProductMetadataAdapter
